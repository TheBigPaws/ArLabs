...
void AARPlaneActor::Tick(float DeltaTime)
{
	...
	//DrawDebugString(GetWorld(), ARCorePlaneObject->GetLocalToWorldTransform().GetLocation() + FVector(0, 0, 0), FString("NORMAL: ").Append(ARCorePlaneObject->GetLocalToWorldTransform().GetRotation().GetUpVector().ToString()), this, FColor(255 - PlaneColor.R, 255 - PlaneColor.G, 255 - PlaneColor.B), 0.0f, false, 2.0f);
	//DrawDebugString(GetWorld(), ARCorePlaneObject->GetCenter() + FVector(0, 0, 10), FString("their Extent: ").Append(ARCorePlaneObject->GetExtent().ToString()), this, FColor(255 - PlaneColor.R, 255 - PlaneColor.G, 255 - PlaneColor.B), 0.0f, false, 2.0f);
	//DrawDebugString(GetWorld(), ARCorePlaneObject->GetCenter() + FVector(0, 0, 20), FString("BoundaryPolygonCount: ").Append(std::to_string(ARCorePlaneObject->GetBoundaryPolygonInLocalSpace().Num()).c_str()), this, FColor(255 - PlaneColor.R, 255 - PlaneColor.G, 255 - PlaneColor.B), 0.0f, false, 2.0f);
